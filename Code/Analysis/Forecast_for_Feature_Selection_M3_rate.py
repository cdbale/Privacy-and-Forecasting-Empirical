...
computation_time = pd.read_csv("../../Data/Computation_Time/M3_rate_computation_time.csv")
...
for m in forecasting_models.items():
    ...
    for f in h2_train_files:
        ...
        computation_time.to_csv("../../Data/Computation_Time/M3_rate_computation_time.csv", index=False)
