...
def import_split_save(time_series_frequency, min_number_series):
    ...
    os.makedirs("../../Data/Cleaned/M3/", exist_ok=True)
    ...
    for cat in categories:
        ...
        # save files
        Y_train_2.to_csv("../../Data/Cleaned/M3/" + time_series_frequency + "-" + cat + "_h2_train" + ".csv", index=False)
        Y_train_1.to_csv("../../Data/Cleaned/M3/" + time_series_frequency + "-" + cat + "_h1_train" + ".csv", index=False)
        Y_test_2.to_csv("../../Data/Cleaned/M3/" + time_series_frequency + "-" + cat + "_h2_test" + ".csv", index=False)
        Y_test_1.to_csv("../../Data/Cleaned/M3/" + time_series_frequency + "-" + cat + "_h1_test" + ".csv", index=False)
