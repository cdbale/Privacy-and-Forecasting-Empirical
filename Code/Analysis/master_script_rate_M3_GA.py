...
# h2_train_files = [x for x in cleaned_files if "_h2_train" in x and "rate_" in x]

# h1_train_files = [x for x in cleaned_files if "_h1_train" in x and "rate_" in x]
...
# # training data for feature selection
# h2_train_files = [x for x in cleaned_files if "_h2_train" in x and "rate_" in x]
# h2_test_files = [x for x in cleaned_files if "_h2_test" in x and "rate_" in x]
...
# og_files = [x[:-12] for x in og_files if not any(y in x for y in ['_train', '_h1_', 'k-nts', 'AN_', 'DP_']) and "rate" in x]
...
# training data for feature selection
h1_train_files = [x for x in cleaned_files if "_h1_train" in x and "rate-GA" in x]
h1_test_files = [x for x in cleaned_files if "_h1_test" in x and "rate" in x]
...
files = [x[:-12] for x in files if not any(y in x for y in ['_train', '_h1_', 'k-nts', 'AN_', 'DP_']) and "rate" in x]
