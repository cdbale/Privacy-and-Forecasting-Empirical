...
back_avg_mae_plot <- back_avg_results %>%
  ...
  labs(x = "Privacy Parameter",
       y = "Average MAE",
       title = "Average MAE Across Forecasting Models and Protected Data Sets (Backtransformed Rates)")
...
back_avg_pbar_plot <- back_avg_results %>%
  ...
  labs(x = "Privacy Parameter",
       ...
       title = "Average Identification Disclosure Across Protected Data Sets (Backtransformed Rates)")
