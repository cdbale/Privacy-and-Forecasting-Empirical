...
# ts_features <- tsfeatures(ts_data, features=c("cv", "outlier_detection", "acf_features", "arch_stat",
#                                               "crossing_points", "entropy", "flat_spots", "heterogeneity",
#                                               "hurst", "hw_parameters", "lumpiness", "max_kl_shift",
#                                               "max_level_shift", "max_var_shift", "nonlinearity",
#                                               "pacf_features", "stability", "stl_features", "unitroot_kpss",
#                                               "unitroot_pp", "compengine"))

ts_features <- tsfeatures(ts_data, features=c("acf_features", "entropy", "stl_features"))
```
...
```{r}
top_1 <- perform_pca(f_pca, "Top_0.4")
top_2 <- perform_pca(f_pca, "Top_0.4")
