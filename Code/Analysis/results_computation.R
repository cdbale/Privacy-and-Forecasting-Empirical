...
write.csv(all_original_results, file="../../Outputs/Results/Tables/all_original_results.csv", row.names = FALSE)
write.csv(all_protected_results, file="../../Outputs/Results/Tables/all_protected_results.csv", row.names = FALSE)
